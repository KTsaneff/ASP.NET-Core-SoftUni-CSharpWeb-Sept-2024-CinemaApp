        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageUrl = table.Column<string>(type: "nvarchar(2083)", maxLength: 2083, nullable: true, defaultValue: "/images/1.jpg"),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Showtimes = table.Column<string>(type: "varchar(5)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("13026732-662e-4ac4-aa7c-b2276ba8a919"), false, "Sofia", "Cinema city" },
                    { new Guid("4e8aed70-73ce-4dbc-9214-448269429ee6"), false, "Plovdiv", "Cinema city" },
                    { new Guid("d9b9cbd6-b6de-4647-a559-12599791ae0c"), false, "Varna", "Cinemax" }
                });
